...
<div class="d-flex">
    ...
    <p>
        ...
        <span class="post-overegg" style="border: 0;">a = f(1, 2) + g(3, 4)</span>
    </p>
</div>
<br>
<div class="d-flex">
...
<br>
<span class="post-overegg" style="border: 0;">출처: https://docs.python.org/3/tutorial/controlflow.html#intermezzo-coding-style</span>